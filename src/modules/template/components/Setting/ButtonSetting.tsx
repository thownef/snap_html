  ...
  return (
    <Space direction='vertical' size='small' className='w-full px-6 py-4 h-[calc(100%-48px)]'>
      <Space direction='vertical' size='small' className='!mb-4 !w-full'>
        ...
        <Input
          onChange={onChangeBlock('content', selectedColumn.blockId, selectedColumn.id)}
          maxLength={1000}
      ...
      <Space direction='vertical' size='small' className='!mb-4 !w-full'>
        ...
        <RadioDesign
          ...
          onChange={onChangeBlock('setting.form', selectedColumn.blockId, selectedColumn.id)}
      ...
      <Space direction='vertical' size='small' className='!mb-4 !w-full'>
        ...
        <RadioDesign
          ...
          onChange={onChangeBlock('setting.size', selectedColumn.blockId, selectedColumn.id)}
          className='[&_.ant-radio-button-wrapper]:w-[95px] [&_.ant-radio-button-wrapper]:text-center'
        />
      </Space>
      ...
      <Space direction='vertical' size='small' className='!mb-4 !w-full'>
        ...
        <ColorPicker
          ...
          onChange={onChangeBlock('setting.color', selectedColumn.blockId, selectedColumn.id)}
          label='文字色'
        />
        <ColorPicker
          placement='top'
          value={'rgb(47, 84, 235)'}
          onChange={onChangeBlock('setting.backgroundColor', selectedColumn.blockId, selectedColumn.id)}
          label='ボタン背景色'
        />
      </Space>
    </Space>
