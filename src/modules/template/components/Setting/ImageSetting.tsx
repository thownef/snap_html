...
import CollectionImageModal from '@/modules/template/components/Modal/CollectionImageModal'
...
const ImageSetting = ({ selectedColumn, onChangeBlock }: ImageSettingProps) => {
  ...
  return (
    <>
        ...
        <Space direction='vertical' size='small' className='fmDqZl mb-4 w-full'>
          <div className='flex'>
            ...
            <div>
              ...
              <Button onClick={onOpenModal('collectionImage')} icon={<AppstoreOutlined />} className='w-[195px] text-center'>
                <Space>画像ライブラリ</Space>
              </Button>
            </div>
          </div>
      ...
      <CollectionImageModal open={modalName === 'collectionImage'} onClose={onCloseModal} />
    </>
  )
}
