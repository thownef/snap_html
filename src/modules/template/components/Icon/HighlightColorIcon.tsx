...
interface HighlightColorIconProps {
  color?: string
}

const HighlightColorIcon = memo(
  ({ color = '#000000' }: HighlightColorIconProps) => {
    return (
      <Icon
        ...
        component={() => (
          <svg viewBox='0 0 16 16' width='1em' height='1em' fill='currentColor'>
            <path
              ...
              transform='scale(0.02) translate(100, 0)'
            />
...
HighlightColorIcon.displayName = 'HighlightColorIcon'
