...
const Iframe = memo(
  ({ content, className, ref, allBackground, background, contentPosition }: IframeProps) => {
    ...
    useEffect(() => {
      ...
      const backgroundElement = iframeDoc.querySelector('#template-background') as HTMLElement
      const blockElement = iframeDoc.querySelector('#template-block') as HTMLElement

      if (backgroundElement) {
        backgroundElement.style.background = allBackground
      }
      if (blockElement) {
        blockElement.style.background = background
        blockElement.setAttribute('align', contentPosition)
      }
    }, [allBackground, background, contentPosition])
  ...
  (prevProps, nextProps) => {
    if (
      ...
      prevProps.allBackground === nextProps.allBackground &&
